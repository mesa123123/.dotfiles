...
-- Bash
local bash_debug_adapter_bin = server_dir .. "/packages/bash-debug-adapter/bash-debug-adapter"
local bashdb_dir = server_dir .. "/packages/bash-debug-adapter/extension/bashdb_dir"
dap.adapters.sh = {
	type = "executable",
