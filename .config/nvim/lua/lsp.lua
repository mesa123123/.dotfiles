...
api.nvim_create_user_command("OtterActivate", function()
    ...
    vim.keymap.set("n", "<leader>cld", ":lua require\"otter\".ask_definition()<cr>",
        keyopts({ desc = "Show Definition" }))
    vim.keymap.set("n", "<leader>clt", ":lua require\"otter\".ask_type_definition()<cr>",
        keyopts({ desc = "Show Type Definition" }))
    vim.keymap.set("n", "<leader>clI", ":lua require\"otter\".ask_hover()<cr>", keyopts({ desc = "Show Info" }))
    vim.keymap.set("n", "<leader>cls", ":lua require\"otter\".ask_document_symbols()<cr>",
