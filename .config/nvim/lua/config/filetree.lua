...
M.set_mappings = function()
  ...
  nmap(lk.file.key .. "c", "Telescope builtin theme=dropdown", "[T]elescope Commands")
  ...
  descMap({ "n" }, lk.file, "sd", ":lua require('telescope.builtin').lsp_document_symbols()<CR>", "[S]ymbols LSP Document")
  nmap(lk.file.key .. "st", "Telescope treesitter theme=dropdown", "[S]ymbols [T]reesitter")
  nmap(lk.file.key .. "r", "Telescope registers theme=dropdown", "[R]egisters")
  nmap(lk.file.key .. "vc", "Telescope commands theme=dropdown", "[V]im [C]ommands")
  nmap(lk.file.key .. "vo", "Telescope vim_options theme=dropdown", "Vim [O]ptions")
  descMap({ 'n' }, lk.argument_files, "a", function ()
    vim.cmd("addarg %")
    vim.cmd("argdedup")
  end, "[A]dd")
  descMap({ 'n' }, lk.argument_files, "e", function ()
    vim.cmd.args()
  end, "[E]xplore")
  nmap(lk.argument_files.key .. "a", "Telescope vim_options theme=dropdown", "[A]rguement [A]dd")
  -- Oil Keymaps
