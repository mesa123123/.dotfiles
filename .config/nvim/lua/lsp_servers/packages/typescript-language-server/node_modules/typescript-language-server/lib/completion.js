...
export async function asResolvedCompletionItem(item, details, document, client, filePathConverter, options, features) {
...
async function isValidFunctionCompletionContext(filepath, position, client, document) {
