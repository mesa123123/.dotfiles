...
export declare class LspServer {
    ...
    selectionRanges(params: lsp.SelectionRangeParams): Promise<lsp.SelectionRange[] | null>;
    ...
    prepareCallHierarchy(params: lsp.CallHierarchyPrepareParams): Promise<lsp.CallHierarchyItem[] | null>;
    callHierarchyIncomingCalls(params: lsp.CallHierarchyIncomingCallsParams): Promise<lsp.CallHierarchyIncomingCall[] | null>;
    callHierarchyOutgoingCalls(params: lsp.CallHierarchyOutgoingCallsParams): Promise<lsp.CallHierarchyOutgoingCall[] | null>;
