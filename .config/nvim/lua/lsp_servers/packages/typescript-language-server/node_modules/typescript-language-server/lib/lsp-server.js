...
export class LspServer {
    ...
    setCompilerOptionsForInferredProjects() {
        ...
        this.tspClient.executeWithoutWaitingForResponse("compilerOptionsForInferredProjects" /* CommandTypes.CompilerOptionsForInferredProjects */, args);
    }
    ...
    async executeCommand(arg, token, workDoneProgress) {
        ...
        if (arg.command === Commands.APPLY_WORKSPACE_EDIT && arg.arguments) {
            ...
            if (this.tspClient?.apiVersion.gte(API.v314)) {
                this.tspClient.executeWithoutWaitingForResponse("configurePlugin" /* CommandTypes.ConfigurePlugin */, {
                    configuration,
                    pluginName,
                });
            }
