...
class CucumberLanguageServer {
    ...
    reindex(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gherkinSources = yield (0, fs_js_1.loadGherkinSources)(__classPrivateFieldGet(this, _CucumberLanguageServer_files, "f"), settings.features);
            ...
            const glueSources = yield (0, fs_js_1.loadGlueSources)(__classPrivateFieldGet(this, _CucumberLanguageServer_files, "f"), settings.glue);
            ...
            try {
                __classPrivateFieldSet(this, _CucumberLanguageServer_suggestions, (0, language_service_1.buildSuggestions)(this.expressionBuilderResult.registry, stepTexts, this.expressionBuilderResult.expressionLinks.map((l) => l.expression)), "f");
                ...
                this.searchIndex = (0, language_service_1.jsSearchIndex)(__classPrivateFieldGet(this, _CucumberLanguageServer_suggestions, "f"));
            }
            catch (err) {
