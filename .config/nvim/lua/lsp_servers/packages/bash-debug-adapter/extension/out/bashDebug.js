...
exports.BashDebugSession = void 0;
...
class BashDebugSession extends vscode_debugadapter_1.LoggingDebugSession {
    ...
    async launchRequest(response, args) {
        ...
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`examine Debug environment: bash_ver=$BASH_VERSION, bashdb_ver=$_Dbg_release, program=$0, args=$*\nprint "$PPID"\nhandle INT stop\nprint '${BashDebugSession.END_MARKER}'\n`);
        const envVars = Object.keys(this.launchArgs.env)
            .map(e => `export ${e}='${this.launchArgs.env[e]}';`)
            .reduce((prev, next) => prev + next, ``);
        const command = this.joinCommands(`${envVars}cd "${args.cwdEffective}"`, `while [[ ! -p "${fifo_path}" ]]; do sleep 0.25; done`, `"${args.pathBash}" "${args.pathBashdb}" --quiet --tty "${fifo_path}" --tty_in "${fifo_path}_in" --library "${args.pathBashdbLib}" -- "${args.programEffective}" ${shell_quote_1.quote(args.args)} ${args.argsString}`);
    ...
    async setBreakPointsRequest(response, args) {
        ...
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`${setBreakpointsCommand}print '${BashDebugSession.END_MARKER}'\n`);
    ...
    async stackTraceRequest(response, args) {
        ...
        await this.onDebuggerAvailable();
        const currentLine = this.fullDebugOutput.length;
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`print backtrace\nbacktrace\nprint '${BashDebugSession.END_MARKER}'\n`);
    ...
    async variablesRequest(response, args) {
        ...
        const currentLine = this.fullDebugOutput.length;
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`${getVariablesCommand}print '${BashDebugSession.END_MARKER}'\n`);
    ...
    async continueRequest(response, args) {
        ...
        await this.onDebuggerAvailable();
        const currentLine = this.fullDebugOutput.length;
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`print continue\ncontinue\nprint '${BashDebugSession.END_MARKER}'\n`);
    ...
    async nextRequest(response, args) {
        ...
        await this.onDebuggerAvailable();
        const currentLine = this.fullDebugOutput.length;
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`print next\nnext\nprint '${BashDebugSession.END_MARKER}'\n`);
    ...
    async stepInRequest(response, args) {
        ...
        await this.onDebuggerAvailable();
        const currentLine = this.fullDebugOutput.length;
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`print step\nstep\nprint '${BashDebugSession.END_MARKER}'\n`);
    ...
    async stepOutRequest(response, args) {
        ...
        await this.onDebuggerAvailable();
        const currentLine = this.fullDebugOutput.length;
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`print finish\nfinish\nprint '${BashDebugSession.END_MARKER}'\n`);
    ...
    async evaluateRequest(response, args) {
        ...
        (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`print 'examine <${expression}>'\nexamine ${expression}\nprint '${BashDebugSession.END_MARKER}'\n`);
    ...
    processDebugTerminalOutput() {
        var _a, _b;
        (_a = this.proxyProcess.stdio[2]) === null || _a === void 0 ? void 0 : _a.on('data', (data) => {
        ...
        this.outputEventSource.schedule(() => {
            ...
            for (; this.fullDebugOutputIndex < this.fullDebugOutput.length - 1; this.fullDebugOutputIndex++) {
                ...
                if (line.indexOf("(") === 0 && line.indexOf("):") === line.length - 2) {
                    ...
                    (_a = this.proxyProcess.stdin) === null || _a === void 0 ? void 0 : _a.write(`\nq\n`);
                    this.sendEvent(new vscode_debugadapter_1.OutputEvent(`Sending TerminatedEvent`, 'telemetry'));
                    this.sendEvent(new vscode_debugadapter_1.TerminatedEvent());
                }
            }
        });
        (_b = this.proxyProcess.stdio[1]) === null || _b === void 0 ? void 0 : _b.on('data', (data) => {
            const list = data.toString().split("\n", -1);
