...
exports.validatePath = exports._validatePath = exports.validatePathResult = void 0;
...
})(validatePathResult = exports.validatePathResult || (exports.validatePathResult = {}));
function _validatePath(cwd, pathBash, pathBashdb, pathCat, pathMkfifo, pathPkill, spawnTimeout = 5000) {
    ...
    if (proc.error !== undefined) {
        if (((_a = proc.error) === null || _a === void 0 ? void 0 : _a["code"]) === "ENOENT") {
            return [vpr.notFoundBash, ""];
        }
        if (((_b = proc.error) === null || _b === void 0 ? void 0 : _b["code"]) === "ETIMEDOUT") {
            return [vpr.timeout, ""];
        }
        return [vpr.unknown, ""];
    }
