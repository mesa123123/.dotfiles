...
exports.spawnBashScriptSync = exports.spawnBashScript = void 0;
...
function spawnBashScript(scriptCode, pathBash, outputHandler) {
    ...
    const spawnedProcess = child_process_1.spawn(currentShell, [optionalBashPathArgument, "-c", scriptCode].filter(arg => arg !== ""), { stdio: ["pipe", "pipe", "pipe"], shell: false });
    if (outputHandler) {
